...
| A3 | waiting-gate | 2026-09-25 | the commit that adds this row | `.meta/DECISIONS.md`: D-01 to D-17 as numbered in the instructions, plus D-18 to D-26 so every DR section and both earlier gate decisions are recorded. Waiting for the analyst to confirm D-14 and D-17. |
| A4 | pending | | | |
| A5 | pending | | | |
| A6 | pending | | | |
| A7 | pending | | | |
